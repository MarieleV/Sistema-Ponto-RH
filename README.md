...
# ⏱️ Sistema de Registro de Ponto Eletrônico
...
<p>
  <img src="https://img.shields.io/badge/arquitetura-monolítica%20em%20camadas-blue?style=flat-square" alt="arquitetura monolítica em camadas" />
...
#### Tela de Login
<img width="600" alt="Tela de Login" src="https://github.com/user-attachments/assets/29cbd8d7-ccb2-4c20-aafc-2fc9342fd6b6" />

<sub>Permite que os usuários acessem o sistema por meio de e-mail e senha.</sub>

<br/><br/>

#### Tela de Batida de Ponto
<img width="600" alt="Tela de Batida de Ponto" src="https://github.com/user-attachments/assets/63266ccf-feef-4fa4-ae70-b0aaa9a05f64" />

<sub>Possibilita o registro das entradas, saídas e intervalos do colaborador.</sub>

<br/><br/>

#### Tela de Ajuste de Ponto
<img width="600" alt="Tela de Ajuste de Ponto" src="https://github.com/user-attachments/assets/edbadc55-7709-44b5-8a91-c01b7ab5d8ad" />

<sub>Permite que o colaborador envie uma solicitação de ajuste de ponto ao administrador, descrevendo sua justificativa e anexando documentos.</sub>

<br/><br/>

#### Tela de Gestão de Justificativas
<img width="600" alt="Tela de Gestão de Justificativas" src="https://github.com/user-attachments/assets/89a3d979-345d-44f8-ad12-0a29422f3170" />

<sub>Fornece a visualização das listagens das justificativas negadas e aceitas, além das que foram recentemente feitas. Ao clicar em cada categoria, acontece o redirecionamento para a respectiva listagem.</sub>

<br/><br/>

#### Tela de Justificativas Aceitas
<img width="600" alt="Tela de Justificativas Aceitas" src="https://github.com/user-attachments/assets/287f50bb-2dff-41f6-836b-d682ab0b6783" />
...
| **Negócio (Back-end/Lógica de Aplicação)** | Aplica regras de negócio, incluindo: **Autenticação** (gerenciamento de usuários, controle de acesso e segurança com JWT), **Registro de ponto** (marcação de entrada, saída e intervalos, validação de horários), **Gestão de usuários** (cadastro, edição e desativação de contas) e **Relatórios** (geração de relatórios simples, acesso apenas para administradores). |
...
Projeto de Aprendizagem Colaborativa Extensionista — Engenharia de Software, Católica de Santa Catarina
