    ...
    <div className="flex flex-col w-full h-full p-6">
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 w-[96%] min-h-full flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3 border-b border-gray-300 pb-3">
          <img src={IconAceitas} alt="Aceitas" className="w-6" />
          <h2 className="text-xl font-semibold">Justificativas Aceitas</h2>
        </div>
...
export default JustificativasAceitas;
